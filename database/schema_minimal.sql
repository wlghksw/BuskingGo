...
CREATE TABLE users (
    ...
    user_id VARCHAR(50) UNIQUE NOT NULL COMMENT '아이디 (로그인 ID)',
...
CREATE TABLE bookings (
    ...
    created_by VARCHAR(20) NULL COMMENT '예약 생성자 유형 (viewer, artist)',
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '생성일시',
    FOREIGN KEY (busker_id) REFERENCES buskers(id) ON DELETE SET NULL,
    INDEX idx_busker_id (busker_id),
    INDEX idx_status (status),
...
CREATE TABLE community_posts (
    ...
    comments INT UNSIGNED DEFAULT 0 COMMENT '댓글 수',
...
CREATE TABLE community_comments (
    ...
    date DATETIME NOT NULL COMMENT '작성일시',
